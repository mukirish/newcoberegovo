...
<script runat="server">
	...
	protected override BXWizardResult OnActionNext(Bitrix.DataTypes.BXCommonBag parameters)
	{
		...
		if (WizardContext.State.Get<Bitrix.DataTypes.BXParamsBag<object>>("Bitrix.CommunitySite.Mvc.Settings").GetBool("InstallDemoData"))
		{
			int[] users = new int[] { GetUserId("fadeeva"), GetUserId("mihalych"), GetUserId("kostik"), GetUserId("artem") };

			long[] forumPosts = new long[] {
				GetForumPost("post02", "topic01","Bitrix.CommunitySite.Mvc.Forum.#SiteId#.general"), 
				GetForumPost("post03", "topic01", "Bitrix.CommunitySite.Mvc.Forum.#SiteId#.general"), 
				GetForumPost("post11", "topic02", "Bitrix.CommunitySite.Mvc.MvcitySite.Forum.#SiteId#.general"), 
				GetForumPost("post31", "topic04", "Bitrix.CommunitySite.Mvc.Forum.#SiteId#.about") 
			};
			...
			int[] blogPosts = new int[] { 
				GetBlogPost("post05", "Bitrix.CommunitySite.Mvc.Blog.#SiteId#.Notes"),
				GetBlogPost("post04", "Bitrix.CommunitySite.Mvc.Blog.#SiteId#.Notes"),
				GetBlogPost("post03", "Bitrix.CommunitySite.Mvc.Blog.#SiteId#.Mihalych"),
				GetBlogPost("post02", "Bitrix.CommunitySite.Mvc.Blog.#SiteId#.Mihalych"),
				GetBlogPost("post01", "Bitrix.CommunitySite.Mvc.Blog.#SiteId#.Fadeeva")
			};
        ...
        if (userRatings.Count == 0)
		{
			...
			rating.Name = "Рейтинг пользователя";
		...
		UI.SetProgressBarValue("Installer.ProgressBar", "Bitrix.CommunitySite.Mvc", 6);
		return Result.Next();
	}
...
Настройка рейтинга и голосований
