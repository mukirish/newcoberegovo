...
<script runat="server">
	...
	protected override BXWizardResult OnActionNext(Bitrix.DataTypes.BXCommonBag parameters)
	{
		...
		//Forums
		var generalForum = GetForum("Bitrix.CommunitySite.Mvc.Forum.#SiteId#.general".Replace("#SiteId#", siteId));
		var aboutForum = GetForum("Bitrix.CommunitySite.Mvc.Forum.#SiteId#.about".Replace("#SiteId#", siteId));
		...
		UI.SetProgressBarValue("Installer.ProgressBar", "Bitrix.CommunitySite.Mvc", 7);
