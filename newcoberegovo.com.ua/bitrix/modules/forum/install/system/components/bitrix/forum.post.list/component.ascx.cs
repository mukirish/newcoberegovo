...
namespace Bitrix.Forum.Components
{
	...
	public partial class ForumPostListComponent : BXComponent
	{
        ...
        {
        	if (this.DateCreateFrom != DateTime.MinValue)
        	{
        		filter.Add(new BXFilterItem(BXForumPost.Fields.DateCreate, BXSqlFilterOperators.GreaterOrEqual, this.DateCreateFrom));
        	}

        	if (this.DateCreateTo != DateTime.MaxValue)
        	{
        		filter.Add(new BXFilterItem(BXForumPost.Fields.DateCreate, BXSqlFilterOperators.LessOrEqual, this.DateCreateTo.AddDays(1).AddMilliseconds(-1)));
        	}
        	...
        	if (this.AuthorId > 0)
        	{
        		filter.Add(new BXFilterItem(BXForumPost.Fields.Author.Id, BXSqlFilterOperators.Equal, this.AuthorId));
        	}

        	filter.Add(new BXFilterItem(BXForumPost.Fields.Forum.Id, BXSqlFilterOperators.In, this.ForumsForSelect));
        }
