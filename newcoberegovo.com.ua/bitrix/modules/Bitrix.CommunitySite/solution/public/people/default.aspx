<%@ Page Language="C#" AutoEventWireup="true" Inherits="Bitrix.UI.BXPublicPage, Main" Title="Люди" %>
...
<div class="content-rounded-box user-search-box" onkeypress="return FireDefaultButton(event, '<%= button.ClientID %>')">
	...
	<div class="inner-box">
		<input name="UserName" value="поиск пользователя" onclick="if (this.value=='поиск пользователя')this.value=''" onblur="if (this.value=='')this.value='поиск пользователя'" onkeyup="AsyncPostBack();" />
	</div>
