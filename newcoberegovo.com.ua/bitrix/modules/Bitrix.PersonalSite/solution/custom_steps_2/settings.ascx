...
<script runat="server">
	...
	protected override void OnWizardInit()
	{
		...
		parameters["Header"] = File.Exists(header) ? File.ReadAllText(header, Encoding.UTF8) : "Блог Виктории Фадеевой";
		
		var footer = BXPath.MapPath(site.DirectoryVirtualPath + "assets/footer.html");
		parameters["Footer"] = File.Exists(footer) ? File.ReadAllText(footer, Encoding.UTF8) : "© Виктория Фадеева, 2010";
