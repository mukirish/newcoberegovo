...
<script runat="server">
	...
	protected override BXWizardResult OnActionNext(Bitrix.DataTypes.BXCommonBag parameters)
	{
		...
		var options = new Dictionary<string, string>
		{
			...
			{"DepositsBackUrl", site.UrlVirtualPath+"services/fiz/deposits/"},
			{"DepositsSefFolder", sef+"services/fiz/deposits/"},
			{"DepositsDetailUrl", site.DirectoryAbsolutePath+"services/fiz/deposits/deposit-#ELEMENT_ID#/"},
