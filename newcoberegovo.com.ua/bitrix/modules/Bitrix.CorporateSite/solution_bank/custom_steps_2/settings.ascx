...
<script runat="server">
	...
	protected override void OnWizardInit()
	{
		...
		parameters["Slogan"] = File.Exists(slogan) ? BXStringUtility.HtmlToText(File.ReadAllText(slogan, Encoding.UTF8)) : "Место для слогана банка находится здесь";
...
<p>Адрес</p>";
	...
	protected override BXWizardResult OnActionShow(Bitrix.DataTypes.BXCommonBag parameters)
	{
		...
		var	view = Result.Render("Настройка решения");
...
<div class="wizard-input-form">
	<div class="wizard-input-form-block">
		<h4>Логотип (максимальный размер 300 X 60)</h4>
	...
	<div class="wizard-input-form-block">
		<h4>Баннер (рекомендуемый размер 580 Х 175)</h4>
		<div class="wizard-input-form-block-content">
