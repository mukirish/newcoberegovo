(function (window) {
    ...
    BX.admin.panel = {
        ...
        redirectURL: "asdf",
        redirect: function () {
            window.location.href = BX.admin.panel.redirectURL;
            //alert(BX.admin.panel.redirectURL);
        },
...
//                    var aPanelSmallToggle = document.querySelector("#bx-panel-small-toggle");  //new
//                    var aPanelToggle = document.querySelector("#bx-panel-toggle"); //new
//                    
//                    aPanelToggle.addEventListener("click", BX.admin.panel.__view_mode_toggle);
//                    aPanelSmallToggle.addEventListener("click", BX.admin.panel.__view_mode_toggle);


//                    BX.admin.panel.redirectURL = aPanelToggle.href;
//                    aPanelToggle.addEventListener("click", BX.admin.panel.redirect);                    
                }
                else {
