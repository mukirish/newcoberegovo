                ...
                <bx:BXTabControlTab ID="BXTabControlTab1" runat="server" Selected="True" Title="<%$ Loc:TabTitle.Main %>" Text="<%$ Loc:TabText.Main %>"> 
                    <table cellpadding="0" cellspacing="0" border="0" class="edit-table" id="fedit1_edit_table" >
				        ...
				        <%} %>
							...
							<tr class="heading">
				                <td colspan="2"><%= GetMessage("Header.PipelineOptimizations")%></td>
				            </tr>	
							<tr>
                                <td width="60%" class="field-name"><%= GetMessage("FieldName.ExcludeFromPipeline") %>: <span id="Span1"></span></td>
                                <td>
                                    <asp:TextBox runat="server" ID="ExcludeFromPipeline" TextMode="SingleLine" Columns="50" />
                                    <br/><small><%= GetMessageRaw("Note.ExcludeFromPipeline") %></small>
                                </td>
                            </tr>			        		                                                                                                                       			            	                                                        
                        </tbody>
                    </table>                
