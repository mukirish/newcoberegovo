...
<bx:BXTabControl ID="BXTabControl1" ValidationGroup="vgInnerForm" runat="server" OnCommand="BXTabControl1_Command">
    ...
    <bx:BXTabControlTab runat="server" Text="<%$ LocRaw:TabText.Users %>" Title="<%$ LocRaw:TabTitle.Users %>" >
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="edit-table">
            ...
            <%  if (BXAuthentication.Providers.OpenId != null) {  %>
                <tr valign="top">
                    <td class="field-name" width="40%">
            ...
            <%  if (BXAuthentication.Providers.Google != null) {  %>
                <tr valign="top">
                    <td class="field-name" width="40%">
                        <%= GetMessage("Label.EnableGoogle")%>:
                    </td>
                    <td width="60%">
                        <asp:CheckBox runat="server" ID="EnableGoogle" />
                    </td>
                </tr>
                <tr valign="top">
                    <td class="field-name" width="40%">
                        <%= GetMessage("Label.GoogleCustomPropertyCode")%>:
                    </td>
                    <td width="60%">
                        <asp:TextBox runat="server" ID="GoogleCustomPropertyCode" />
                    </td>
                </tr>
            <%  }  %>

            <%  if (BXAuthentication.Providers.Yahoo != null) {  %>
                <tr valign="top">
                    <td class="field-name" width="40%">
                        <%= GetMessage("Label.EnableYahoo")%>:
                    </td>
                    <td width="60%">
                        <asp:CheckBox runat="server" ID="EnableYahoo" />
                    </td>
                </tr>
                <tr valign="top">
                    <td class="field-name" width="40%">
                        <%= GetMessage("Label.YahooCustomPropertyCode")%>:
                    </td>
                    <td width="60%">
                        <asp:TextBox runat="server" ID="YahooCustomPropertyCode" />
                    </td>
                </tr>
            <%  }  %>

            <%  if (BXAuthentication.Providers.Yandex2 != null) {  %>
                <tr valign="top">
                    <td class="field-name" width="40%">
                        <%= GetMessage("Label.EnableYandex2")%>:
                    </td>
                    <td width="60%">
                        <asp:CheckBox runat="server" ID="EnableYandex2" />
                    </td>
                </tr>
                <tr valign="top">
                    <td class="field-name" width="40%">
                        <%= GetMessage("Label.Yandex2CustomPropertyCode")%>:
                    </td>
                    <td width="60%">
                        <asp:TextBox runat="server" ID="Yandex2CustomPropertyCode" />
                    </td>
                </tr>
            <%  }  %>

            <%  if (BXAuthentication.Providers.WindowsLive != null) {  %>
                <tr valign="top">
                    <td class="field-name" width="40%">
            ...
            <%  if (BXAuthentication.Providers.Yandex != null) {  %>
                <tr valign="top">
                    <td class="field-name" width="40%">
                        <%= GetMessage("Label.EnableYandex")%>:
                    </td>
                    <td width="60%">
                        <asp:CheckBox runat="server" ID="EnableYandex" />
                    </td>
                </tr>
                <tr valign="top">
                    <td class="field-name" width="40%">
                        <%= GetMessage("Label.YandexCustomPropertyCode")%>:
                    </td>
                    <td width="60%">
                        <asp:TextBox runat="server" ID="YandexCustomPropertyCode" />
                    </td>
                </tr>
                 <tr valign="top">
                    <td class="field-name">
                        <%= GetMessage("YandexApplicationID") + ":"%>
                    </td>
                    <td>
                        <asp:TextBox runat="server" ID="YandexApplicationID" Columns="30"></asp:TextBox>
                        <a href="https://oauth.yandex.ru/client/my" target="_blank"><%=GetMessage("GetYandexAppIdAndKey")%></a>
                    </td>
                
                </tr>
                <tr valign="top">
                    <td class="field-name">
                        <%= GetMessage("YandexSecretKey") + ":"%>
                    </td>
                    <td>
                        <asp:TextBox runat="server" ID="YandexSecretKey" Columns="30"></asp:TextBox>
                    </td>
                </tr>
            <%  }  %>

            <%  if (BXAuthentication.Providers.Facebook != null)  {  %>
                <tr valign="top">
                    <td class="field-name" width="40%">
                        <%= GetMessage("Label.EnableFacebook")%>:
                    </td>
                    <td width="60%">
                        <asp:CheckBox runat="server" ID="EnableFacebook" />
                    </td>
                </tr>
                <tr valign="top">
                    <td class="field-name" width="40%">
                        <%= GetMessage("Label.FacebookCustomPropertyCode")%>:
                    </td>
                    <td width="60%">
                        <asp:TextBox runat="server" ID="FacebookCustomPropertyCode" />
                    </td>
                </tr>
                 <tr valign="top">
                    <td class="field-name">
                        <%= GetMessage("FacebookApplicationID") + ":"%>
                    </td>
                    <td>
                        <asp:TextBox runat="server" ID="FacebookApplicationID" Columns="30"></asp:TextBox>
                        <a href="https://developers.facebook.com/apps" target="_blank"><%=GetMessage("GetFacebookAppIdAndKey")%></a>
                    </td>
                
                </tr>
                <tr valign="top">
                    <td class="field-name">
                        <%= GetMessage("FacebookSecretKey") + ":"%>
                    </td>
                    <td>
                        <asp:TextBox runat="server" ID="FacebookSecretKey" Columns="30"></asp:TextBox>
                    </td>
                </tr>
            <% } %>
        </table>
