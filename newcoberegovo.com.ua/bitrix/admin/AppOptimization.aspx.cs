...
public partial class bitrix_admin_AppOptimization : BXAdminPage
{
    ...
    protected override void OnLoad(EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
				...
				ExcludeFromPipeline.Text = BXConfigurationUtility.Options.ExtensionsExcludedFromPipelineString;
            }
            else
            {
                Validate();
    ...
    {
        Settings.Save();
		BXConfigurationUtility.Options.ExtensionsExcludedFromPipelineString = ExcludeFromPipeline.Text;
    }
