<%@ Page Language="C#" Inherits="Bitrix.UI.BXPublicPage, Main"                             Title="News" %>
...
<div class="newCo_h1"> 
  <h1>Hírek   <img src="/bitrix/templates/newco_first/img/news_img.png"  />      </h1>
            
    ...
    <tbody> 
      <tr><td> <iframe width="300" height="130" fram'+'eborder="0" src="http://informer.minfin.com.ua/gen/course/?color=yellow" vspace="0" scrolling="no" hspace="0" allowtransparency="true" style="width: 300px; height: 130px; float: right;"></iframe> </td> <td></td><td> 
          <div id="SinoptikInformer" style="width: 350px; float: left;" class="SinoptikInformer type5c1"> 
            <div class="siHeader"> 
              <div class="siLh"> 
                <div class="siMh"><a onmousedown="siClickCount();" href="https://ua.sinoptik.ua/" target="_blank" >Időj&aacute;rás</a><a onmousedown="siClickCount();" class="siLogo" href="https://ua.sinoptik.ua/" target="_blank" > </a> <span id="siHeader"></span></div>
               </div>
             </div>
              ...
              <table style="border-collapse: collapse;"> 
                <tbody> 
                  <tr><td class="siCityV" style="width: 100%; float: left;"> 
                      <div class="siCityName"><a onmousedown="siClickCount();" href="https://ua.sinoptik.ua/погода-берегове" target="_blank" >Időjárás <span>Beregszászban</span></a></div>
                     </td></tr>
                  ...
                  <tr><td style="width: 100%; float: left;"> 
                      <div class="siCityV2"> 
                        <div id="siCont0" class="siBodyContent"> 
                          ...
                          <div class="siInf"> 
                            <p>Páratartalom: <span id="vl0"></span></p>
                           
                            <p>L&eacute;gnyomás: <span id="dav0"></span></p>
                           
                            <p>Szél: <span id="wind0"></span></p>
                           </div>
                         </div>
                       </div>
                     </td></tr>
...
<bx:IncludeComponent
 ...
 IBlockUrlTitle="Vissza a h&iacute;rekhez"
 UseRss="False"
 RssDaysCount=""
 RssElementsCount="20"
 AllowComments="False"
